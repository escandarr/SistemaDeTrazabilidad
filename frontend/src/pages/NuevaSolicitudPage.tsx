...
import type { MaterialCalculado, Page, Producto, Receta } from '../types'
...
export function NuevaSolicitudPage({ recetas, stock, onCreated, navigate }: Props) {
    ...
    return (
      <div className="success-screen">
        ...
        <div style={{ display: 'flex', gap: 10, justifyContent: 'center' }}>
          ...
          <button className="btn btn--secondary" onClick={() => navigate('dashboard')}>Volver al inicio</button>
        </div>
      </div>
    )
  }
